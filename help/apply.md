...
- [`edit-last-applied`](apply/edit-last-applied.md) — Edit latest last-applied-configuration annotations of a resource/object
- [`set-last-applied`](apply/set-last-applied.md) — Set the last-applied-configuration annotation on a live object to match the contents of a file
- [`view-last-applied`](apply/view-last-applied.md) — View the latest last-applied-configuration annotations of a resource/object
...
> Use "oc apply `<command>` --help" for more information about a given command.
