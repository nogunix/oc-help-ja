...
[`oc`](../oc.md) / [`oc policy`](../policy.md) / `remove-role-from-user`

## Usage

```
oc policy remove-role-from-user ROLE USER [USER ...] [flags] [options]
```
...
<sub>`$ oc policy remove-role-from-user --help` / `gen-oc-help.py` で生成</sub>
