...
> edge TLS 終端を使うルートを作成する

[`oc`](../../oc.md) / [`oc create`](../../create.md) / [`oc create route`](../route.md) / `edge`
...
```bash
# frontend サービスを公開する "my-route" という名前の edge ルートを作成する
oc create route edge my-route --service=frontend

# frontend サービスを公開する edge ルートを作成し、パスを指定する
# ルート名を省略した場合は、Service 名が使用されます
...
<sub>`$ oc create route edge --help` / `gen-oc-help.py` で生成</sub>
