...
> 指定した名前で namespace を作成する

[`oc`](../oc.md) / [`oc create`](../create.md) / `namespace`

## Usage

```
oc create namespace NAME [--dry-run=server|client|none] [options]
```
...
```bash
# my-namespace という名前の namespace を新規作成する
...
<sub>`$ oc create namespace --help` / `gen-oc-help.py` で生成</sub>
